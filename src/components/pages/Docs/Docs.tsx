    ...
    <PageContainer>
      ...
      <Stack p={5} gap={5}>
        <Text>
          ...
          Градиште“донела је ИНФОРМАТОР О РАДУ ДОМА ЗДРАВЉА Велико Градиште.
          <br />
          Овим информатором ближе се одређује садржина, обим као и поступак за
          остваривање права заинтересованих лица на приступ информацијама од
          јавног значаја.
          <br />
          Ради спровођења Закона о слободном приступу информацијама од јавног
          значаја Информатор садржи основне податке о раду Дома здравља Велико
          Градиште.
        </Text>
